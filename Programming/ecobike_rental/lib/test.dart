...
class Home extends StatelessWidget {
  Future<String> fetchAlbum() async {
    ...
    final String md5 = generateMd5(Autogenerated(
...
class Reseponse {
  ...
  Reseponse({this.hashCode1, this.appCode, this.version, this.transaction});

  Reseponse.fromJson(Map<String, dynamic> json) {
...
class Autogenerated {
  ...
  Autogenerated({this.secretKey, this.transaction});
